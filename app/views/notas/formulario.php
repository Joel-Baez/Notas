<section class="tarjeta">
    ...
    <form method="post" action="?entidad=notas&accion=<?= $accion ?><?= $accion === 'actualizar' ? '&materia=' . urlencode($nota['materia']) . '&estudiante=' . urlencode($nota['estudiante']) . '&actividad=' . urlencode($nota['actividad']) : '' ?>" class="formulario">
        <div class="campo">
        ...
        <div class="campo">
            ...
            <input type="number" step="0.01" min="0.01" max="4.99" id="nota" name="nota" required value="<?= htmlspecialchars($nota['nota']) ?>">
        </div>
